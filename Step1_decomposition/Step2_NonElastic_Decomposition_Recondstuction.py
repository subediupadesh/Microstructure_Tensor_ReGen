...
dense_tensor = np.load('noelastic_tensor.npy')
...
###### Sparse with 10% ##############
#####################################
print("Starting CP Decomposition for 10 percent sparse tensor")
p1 = 0.10
...
np.save(path+'/reconstructed_tensors/nonelastic_reconstruction/recon_cpd_tensor_1.npy', recon_tensor_1)
np.save(path+'/reconstructed_tensors/nonelastic_reconstruction/rmse_cpd_1.npy', rmse_1)
...
####### Sparse with 15% ##############
######################################
print("Starting CP Decomposition for 15 percent sparse tensor")
p2 = 0.15
...
np.save(path+'/reconstructed_tensors/nonelastic_reconstruction/recon_cpd_tensor_2.npy', recon_tensor_2)
np.save(path+'/reconstructed_tensors/nonelastic_reconstruction/rmse_cpd_2.npy', rmse_2)
...
np.save(path+'/reconstructed_tensors/nonelastic_reconstruction/recon_cpd_tensor_3.npy', recon_tensor_3)
np.save(path+'/reconstructed_tensors/nonelastic_reconstruction/rmse_cpd_3.npy', rmse_3)
...
def tucker_decomposition(dense_tensor, sparse_tensor, rank, lambda0, maxiter):
    ...
    for it in range(maxiter):
        ...
        rmse.append(rse)
        if (it + 1) % show_iter == 0:
            print(f'Iter: {it+1} finished at: {time.time()}')
            print(rse)
            print()
...
p1 = 0.10
sparse_tensor_1 = dense_tensor * random_tensor_generator(p1, dense_tensor.shape)
print("Starting Tucker Decomposition for 20 percentage sparse tensor")
import time
start = time.time()
rank = np.array([100, 100, 100]) #np.array([100, 100, 100])
lambda0 = 1e-4
recon_tuc_tensor_1, G, U, V, X, rmse_1 = tucker_decomposition(dense_tensor, sparse_tensor_1, rank, lambda0, maxiter=500)
end = time.time()
print('Running time: %d seconds'%(end - start))
np.save(path+'/reconstructed_tensors/nonelastic_reconstruction/recon_ttd_tensor_1.npy', recon_tuc_tensor_1)
np.save(path+'/reconstructed_tensors/nonelastic_reconstruction/rmse_ttd_1.npy', rmse_1)
##########################################
...
print('Running time: %d seconds'%(end - start))
np.save(path+'/reconstructed_tensors/nonelastic_reconstruction/recon_ttd_tensor_2.npy', recon_tuc_tensor_2)
np.save(path+'/reconstructed_tensors/nonelastic_reconstruction/rmse_ttd_02.npy', rmse_2)
##########################################
...
print('Running time: %d seconds'%(end - start))
np.save(path+'/reconstructed_tensors/nonelastic_reconstruction/recon_ttd_tensor_3.npy', recon_tuc_tensor_3)
np.save(path+'/reconstructed_tensors/nonelastic_reconstruction/rmse_ttd_03.npy', rmse_3)
##########################################
