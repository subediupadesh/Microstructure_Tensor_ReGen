...
dense_tensor = np.load('elastic_tensor.npy')
...
np.save(path+'/reconstructed_tensors/elastic_reconstruction/recon_cpd_tensor_1.npy', recon_tensor_1)
np.save(path+'/reconstructed_tensors/elastic_reconstruction/rmse_cpd_1.npy', rmse_1)
...
np.save(path+'/reconstructed_tensors/elastic_reconstruction/recon_cpd_tensor_2.npy', recon_tensor_2)
np.save(path+'/reconstructed_tensors/elastic_reconstruction/rmse_cpd_2.npy', rmse_2)
...
np.save(path+'/reconstructed_tensors/elastic_reconstruction/recon_cpd_tensor_3.npy', recon_tensor_3)
np.save(path+'/reconstructed_tensors/elastic_reconstruction/rmse_cpd_3.npy', rmse_3)
...
np.save(path+'/reconstructed_tensors/elastic_reconstruction/recon_ttd_tensor_1.npy', recon_tuc_tensor_1)
np.save(path+'/reconstructed_tensors/elastic_reconstruction/rmse_ttd_1.npy', rmse_1)
##########################################
...
print('Running time: %d seconds'%(end - start))
np.save(path+'/reconstructed_tensors/elastic_reconstruction/recon_ttd_tensor_2.npy', recon_tuc_tensor_2)
np.save(path+'/reconstructed_tensors/elastic_reconstruction/rmse_ttd_02.npy', rmse_2)
##########################################
...
print('Running time: %d seconds'%(end - start))
np.save(path+'/reconstructed_tensors/elastic_reconstruction/recon_ttd_tensor_3.npy', recon_tuc_tensor_3)
np.save(path+'/reconstructed_tensors/elastic_reconstruction/rmse_ttd_03.npy', rmse_3)
##########################################
